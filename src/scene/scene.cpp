...
Scene Scene::simpleScene() {
    ...
    //lights.push_back(make_shared<PointLight>(vec3(0, 10, 0), vec3(50), vec3(0.05f)));
...
Scene Scene::lightScene() {
    ...
    //lights.push_back(make_shared<PointLight>(vec3(-5, 0, 0), vec3(50), vec3(0.05f)));
...
Scene Scene::shapeScene() {
    ...
    //objects.push_back(make_shared<SceneObject>(make_shared<Disk>(vec3(3, 0, -5), 0.5), white));
    objects.push_back(make_shared<SceneObject>(make_shared<Plane>(vec3(1, 0, -5), vec3(0.5)),white));
